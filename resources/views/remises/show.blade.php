...
@section('header')
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">Détail de la remise</h2>
@endsection
    ...
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow-xl rounded-lg p-8">
            ...
            <div class="mt-8 flex gap-4">
                <a href="{{ route('remises.edit', $remise) }}" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 flex items-center gap-2">
                    <i class="fas fa-edit"></i> Modifier
                </a>
                <form action="{{ route('remises.destroy', $remise) }}" method="POST" onsubmit="return confirm('Supprimer cette remise ?')">
                    @csrf
                    @method('DELETE')
                ...
                <a href="{{ route('remises.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 flex items-center gap-2">
