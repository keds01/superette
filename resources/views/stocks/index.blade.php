...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <!-- Affichage de la superette active -->
        @if(isset($activeSuperette))
            <div class="p-4 mb-4 text-blue-700 bg-blue-100 border border-blue-200 rounded-md">
                <div class="flex items-center">
                    <i class="mr-2 text-xl fas fa-store"></i>
                    <span class="font-medium">Vous consultez les stocks de la superette : {{ $activeSuperette->nom }}</span>
                </div>
            </div>
        @else
            <div class="p-4 mb-4 text-yellow-700 bg-yellow-100 border border-yellow-200 rounded-md">
                <div class="flex items-center">
                    <i class="mr-2 text-xl fas fa-exclamation-triangle"></i>
                    <span class="font-medium">Vous consultez les produits sans superette assignée. 
                        <a href="{{ route('superettes.select') }}" class="underline">Cliquez ici pour sélectionner une superette</a>.
                    </span>
                </div>
            </div>
        @endif
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-10 animate-fade-in-down">
            ...
            <div class="flex flex-wrap gap-4">
                ...
                @if($estConnecte && !$isCaissier)
                    ...
                    <a href="/mouvements-stock" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-tr from-green-600 to-emerald-500 text-white font-bold shadow-xl hover:shadow-neon hover:-translate-y-1 transition-all duration-200">
                    ...
                    <div class="overflow-x-auto shadow-2xl ring-1 ring-indigo-200 ring-opacity-40 sm:rounded-2xl bg-white/70 backdrop-blur-xl">
                        <table class="min-w-full divide-y divide-indigo-100">
                            ...
                            <tbody class="divide-y divide-indigo-50 bg-white/80">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="px-3 py-4 text-sm text-gray-500 text-center">Aucun produit trouvé</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
