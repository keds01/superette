    ...
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white/60 backdrop-blur-xl border border-violet-100 rounded-2xl shadow-2xl p-8 md:p-10">
            <div class="mb-8 text-center">
                ...
                <p class="mt-3 text-gray-600">Remplissez les informations ci-dessous pour ajouter un nouvel employé.</p>
            </div>
            ...
            <form action="{{ route('employes.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700">Mot de passe <span class="text-red-500">*</span> <i class="fas fa-info-circle text-gray-400" data-bs-toggle="tooltip" title="Mot de passe pour l'accès au système"></i></label>
                        <input type="password" 
                               name="password" 
                               id="password" 
                               class="mt-1 block w-full rounded-xl border-gray-300 focus:border-violet-500 focus:ring focus:ring-violet-200 focus:ring-opacity-50 shadow-sm"
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-sm font-medium text-gray-700">Confirmer le mot de passe <span class="text-red-500">*</span> <i class="fas fa-info-circle text-gray-400" data-bs-toggle="tooltip" title="Confirmez le mot de passe"></i></label>
                        <input type="password" 
