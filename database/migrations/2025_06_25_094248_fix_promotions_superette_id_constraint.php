...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement('UPDATE promotions SET superette_id = 1 WHERE superette_id IS NULL');
        ...
        Schema::table('promotions', function (Blueprint $table) {
            ...
            $foreignKeys = DB::select(
                ...
                AND CONSTRAINT_NAME LIKE 'promotions_%_foreign'"
            );
        ...
        DB::statement('ALTER TABLE promotions MODIFY superette_id BIGINT UNSIGNED NOT NULL');
    ...
    public function down(): void
    {
        ...
        DB::statement('ALTER TABLE promotions MODIFY superette_id BIGINT UNSIGNED NULL');
